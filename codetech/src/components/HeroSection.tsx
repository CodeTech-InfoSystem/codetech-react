  ...
  return (
    <section className="text-white relative mt-[4.375rem]">
      <div className="max-w-7xl mx-auto text-center px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#AD954F] via-[#BCA86F] via-[#CDBF95] via-[#DED4B8] via-[#EBE6D5] to-white leading-[70px]">
          Software Services Enabling <br />
          <span className="block">Business Competence</span>
        </h1>

        <p className="mt-[33px] text-lg text-gray-300 w-full md:w-[40%] mx-auto font-raleway leading-[32px]">
        ...
        <div className="my-6 flex justify-center gap-4">
          <Link
            href="/contact-us"
            className="px-10 py-2 bg-[#AD954F] text-white font-bold rounded-2xl lg:w-[234px] lg:h-[42px] leading-[1.5]"
          >
            Enquiry
          </Link>
        </div>
        ...
        <Link
          href="/services"
          className="px-6 py-2 border-b border-white text-white font-semibold"
        >
          Our Services
        </Link>
      ...
      {/* Stars only on large screens */}
      <motion.div
        className="absolute top-[25%] left-[10%] text-white text-2xl hidden lg:block"
        animate={{ rotate: 360 }}
