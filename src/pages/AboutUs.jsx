...
const AboutUs = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* Mission Section */}
            <section className="mt-10 flex flex-col md:flex-row items-center px-4 lg:px-20">
                <img src="/images/mission.svg" alt="Our Mission" className="w-full md:w-1/2 rounded-lg md:w-[582px] md:h-[508px] wow animate__animated animate__slideInLeft"
                    data-wow-duration="1s"/>
            ...
            {/* Vision Section */}
            <section className="mt-10 flex flex-col-reverse md:flex-row items-center px-4 lg:px-20">
